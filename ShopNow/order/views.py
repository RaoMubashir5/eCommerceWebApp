...
class orderApi(APIView):
    ...
    def post(self,request):
            ...
            print("yahantak ok ha")
            checkout_id=request.POST.get('checkout_page_id') #pass param
            bill=request.POST.get('total_bill')#pass in query param
            print("02 yahan tak ok ha")
